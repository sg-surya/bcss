...
const alumniList = [
  { name: "Atul Chaudhary", role: "Supervisor", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200" },
  { name: "Aruna", role: "Sales Executive", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=200" },
  { name: "Bulbul", role: "Accountant", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=200" },
  { name: "Johnson", role: "Senior Developer", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200" },
  ...
  { name: "Marina Doe", role: "Product Manager", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=200" },
];
  ...
  return (
    <section id="alumni" className="py-24 bg-[#e5e5e5] overflow-hidden">
      ...
      <div className="relative w-full flex flex-col gap-6 pb-10">
        ...
        {/* Row 2 (Reverse) */}
        <div className="flex gap-6 w-max animate-marquee-reverse -ml-48 hover:[animation-play-state:paused]">
