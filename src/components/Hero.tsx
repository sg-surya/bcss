...
import { ArrowRight, MessageCircle, Star, CheckCircle2, Award, Play } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-5 relative mt-16 lg:mt-0">
          ...
          >
            ...
            <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] shadow-2xl border-4 border-white bg-gray-100">
              <img 
            ...
            <motion.div 
              ...
              className="absolute -top-8 -right-8 bg-white p-4 rounded-2xl shadow-xl border border-black/5 flex items-center gap-4 z-20"
            >
            ...
            <motion.div 
              ...
              className="absolute top-1/2 -left-12 bg-white p-3 rounded-2xl shadow-xl border border-black/5 flex items-center gap-3 z-20"
            >
